...
This is meant as a starting point, from where users can adapt it to their own needs. Most of the code including this readme file has been generated by ChatGPT. 
...
## Demo
The project is live on [GitHub Pages](https://lcalmbach.github.io/project-bubble-chart/)

## Installation
1. Clone the repository:
   ```bash
   git clone https://github.com/lcalmbach/project-bubble-chart.git
   ```
